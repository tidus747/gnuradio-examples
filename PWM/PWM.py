...
class PWM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._out_gain_win = RangeWidget(self._out_gain_range, self.set_out_gain, 'Volumen OUT', "counter_slider", float)
        self.top_grid_layout.addWidget(self._out_gain_win)
        self._in_gain_range = Range(0, 5, 0.05, 0.2, 200)
        self._in_gain_win = RangeWidget(self._in_gain_range, self.set_in_gain, 'Volumen IN', "counter_slider", float)
        self.top_grid_layout.addWidget(self._in_gain_win)
        self._carrier_lvl_range = Range(0, 1, 0.01, 0.2, 200)
        self._carrier_lvl_win = RangeWidget(self._carrier_lvl_range, self.set_carrier_lvl, 'Carrier Gain', "counter_slider", float)
        ...
        labels = ['Original', 'Carrier', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_TRI_WAVE, 60000, carrier_lvl, -(carrier_lvl)/2, 1.5707)
        ...
        self.connect((self.analog_sig_source_x_0, 0), (self.qtgui_time_sink_x_0_1, 1))
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.audio_sink_0, 0))
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.qtgui_time_sink_x_0_0, 0))
        self.connect((self.blocks_multiply_const_vxx_0_0, 0), (self.epy_block_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 12000, 10, firdes.WIN_HAMMING, 6.76))
    ...
    def set_out_gain(self, out_gain):
        ...
        self.blocks_multiply_const_vxx_0.set_k(self.out_gain)
    ...
    def set_in_gain(self, in_gain):
        ...
        self.blocks_multiply_const_vxx_0_0.set_k(self.in_gain)

    def get_carrier_lvl(self):
        return self.carrier_lvl

    def set_carrier_lvl(self, carrier_lvl):
        self.carrier_lvl = carrier_lvl
        self.analog_sig_source_x_0.set_amplitude(self.carrier_lvl)
        self.analog_sig_source_x_0.set_offset(-(self.carrier_lvl)/2)



def main(top_block_cls=PWM, options=None):
